...
**Vtable - C++ Interview Questions**

1. Does every instance of a class have its own <code>vtable</code>, or do they share it?
2. Can we call a <code>virtual function</code> from a constructor or a destructor? What happens if we do?
3. What happens to the <code>vtable</code> if a class has no <code>virtual functions</code>, or if the base class has <code>virtual functions</code> but the derived class does not override them?
4. Is the <code>vptr</code> initialized at compiletime or runtime?
5. How does the <code>vtable mechanism</code> affect the memory footprint of an object?
6. Have you ever had to debug an issue related to <code>object memory layout</code> or <code>vtable pointer corruption</code>?
